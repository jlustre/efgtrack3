...
class EmailTemplateSeeder extends Seeder
{
    public function run(): void
    {
        ...
        <p class="isSelectedEnd">A new associate has successfully registered in {{ app_name }} and is ready to begin their onboarding journey.</p>
        <p class="isSelectedEnd"><strong>New Associate Information</strong></p>
        <p class="isSelectedEnd"><strong>Name</strong>: {{ member_name }}<br><strong>Email</strong>: {{ member_email }}<br><strong>Sponsor</strong>: {{ sponsor_name }}</p>
        ...
        <p class="isSelectedEnd"><strong>Member Name</strong>: {{ member_name }}<br><strong>Sponsored By</strong>: {{ sponsor_name }}<strong><br>Member Email:</strong> {{ member_email }}<br><strong>Profile Link</strong>: {{ profile_url }}</p>
        <h3>Action Required</h3>
        ...
        <p class="isSelectedEnd">{{ first_contact_url }}</p>
        ...
        <p class="isSelectedEnd">{{ registration_link }}</p>
