<div class="rounded-lg border border-slate-400 bg-gradient-to-br from-white via-[#F8FAFC] to-purple-50 p-6 shadow-sm">
            ...
            <tbody class="divide-y divide-slate-200">
                @forelse ($rows as $row)
                    <tr>
                        ...
                        <td class="px-4 py-3 text-slate-600">{{ $row->owner_name }}</td>
                ...
                @empty
                    <tr><td colspan="4" class="px-4 py-6 text-center text-slate-500">No shared prospects assigned to you.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
