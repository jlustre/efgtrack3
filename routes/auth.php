...
Route::middleware('guest')->group(function () {
    ...
    Route::get('email/verification/resend', [ResendEmailVerificationController::class, 'create'])
        ->name('verification.resend');

    Route::post('email/verification/resend', [ResendEmailVerificationController::class, 'store'])
